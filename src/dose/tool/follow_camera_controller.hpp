/**
 *  Time-stamp:  <2009-06-15 13:22:49 raskolnikov>
 *
...
{
public:
    static const float DEFAULT_DISTANCE = 80.0;
    static const float DEFAULT_ANGLE    = M_PI / 16;
    static const float DEFAULT_SPEED    = 0.01;
