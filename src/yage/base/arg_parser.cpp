...
YAGE_DEFINE_ERROR_WHERE (arg_parser_error, "arg_parser")
YAGE_DEFINE_ERROR_WHAT  (unknown_option_error, "Unknown option.")
YAGE_DEFINE_ERROR_WHAT  (parse_option_error,   "Error while parsing option parameter.")
