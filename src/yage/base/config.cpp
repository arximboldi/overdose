...
YAGE_DEFINE_ERROR_WHERE (config_error, "config");
YAGE_DEFINE_ERROR_WHAT  (config_type_error, "Config node type mismatch.");
YAGE_DEFINE_ERROR_WHAT  (config_backend_error, "Config node has no backend.");
