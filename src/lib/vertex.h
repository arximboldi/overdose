...
//
// Domingo Martin Perandres 2003,2004,2005
//
// GPL
//**************************************************************************
...
const int MAX_INT_VALUE=(int) pow((float) 2,(int) sizeof(int))-1;
...
_vertex3	vector_product(const _vertex3<Type> &Vertex1);
...
_vertex3 	&normalize();
Type			module(){return (sqrt(x*x+y*y+z*z));};
...
_vertex4 	&normalize();
Type			module(){return (sqrt(x*x+y*y+z*z+w*w));};
...
bool Computed;
      ...
      _bounding_box3(Type XMin1=(Type) MAX_FLOAT_VALUE, Type YMin1=MAX_FLOAT_VALUE, Type ZMin1=MAX_FLOAT_VALUE, Type XMax1=(Type) -MAX_FLOAT_VALUE, Type YMax1=-MAX_FLOAT_VALUE, Type ZMax1=-MAX_FLOAT_VALUE);
...
typedef _vertex2<unsigned char> 		_vertex2ub;
...
typedef _vertex3<unsigned char> 		_vertex3ub;
...
typedef _vertex4<unsigned char> 		_vertex4ub;
...
template <> void
_vertex2<double>::show_values()
{

printf("vertex: x=%lf y=%lf\n",x,y);
}
...
template <class Type> _vertex3<Type>
_vertex3<Type>::vector_product(const _vertex3<Type> &Vertex1)
{
...
Auxiliar=this->vector_product(Vertex1);
...
template <> void
_vertex3<int>::show_values()
{

printf("vertex: x=%d y=%d z=%d\n",x,y,z);
}

template <> void
_vertex3<float>::show_values()
{
...
template <> void
_vertex3<double>::show_values()
{

printf("vertex: x=%lf y=%lf z=%lf\n",x,y,z);
}
...
template <> void
_vertex4<int>::show_values()
{

printf("vertex: x=%d y=%d z=%d w=%d\n",x,y,z,w);
}

template <> void
_vertex4<float>::show_values()
{
...
template <> void
_vertex4<double>::show_values()
{

printf("vertex: x=%lf y=%lf z=%lf w=%lf\n",x,y,z,w);
}
...
if (Result>COPLANE_THRESHOLD) return VERTEX_AHEAD_PLANE;
if (Result<-COPLANE_THRESHOLD) return VERTEX_BEHIND_PLANE;
...
{
Type Max_value=-MAX_FLOAT_VALUE;
